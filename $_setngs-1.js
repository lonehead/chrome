...
if (ss.nick == username)
{
	...
	var chat_attack = "хром гоу"; // спец. команда начать бой

	var chat_mif = "нука миф"; // спец. команда на драка
	var chat_vel = "нука велы"; // спец. команда на велов
	var chat_troll = "нука троль"; // спец. команда на троля
	var chat_nemka = "нука (немка|нема)"; // спец. команда на нему
	var chat_zod = "зод6"; // спец. команда на зода
	var chat_pred = "свят6"; // спец. команда на святилище предков
	var chat_legn = "лег6"; // спец. команда на легион
	var chat_trof = "нука троф"; // спец. команда на трофа
	var chat_exit = "нука выход"; // спец. команды на выход из пещер

	var chat_altar = "хром альт|нука альт"; // спец. команды на взятие алтаря

	var chat_start = "нука старт"; // спец. команда на старт
	var chat_stop = "нука стоп"; // спец. команда на стоп
	...
	var terra_clan_tag = "пят"; // клановый тег для команд на территориях
