...
if (ss.nick == username)
{
	...
	var chat_attack = "абис гоу"; // спец. команда начать бой

	var chat_mif = "абис миф"; // спец. команда на драка
	var chat_vel = "абис велы"; // спец. команда на велов
	var chat_troll = "абис троль"; // спец. команда на троля
	var chat_nemka = "абис нем(к)?а"; // спец. команда на нему
	var chat_zod = "абис зод"; // спец. команда на зода
	var chat_pred = "абис свят"; // спец. команда на святилище предков
	var chat_legn = "абис лег"; // спец. команда на легион
	var chat_trof = "абис троф"; // спец. команда на трофа
	var chat_exit = "абис выход"; // спец. команды на выход из пещер

	var chat_altar = "абис альт"; // спец. команды на взятие алтаря

	var chat_start = "абис старт"; // спец. команда на старт
	var chat_stop = "абис стоп"; // спец. команда на стоп
